...
def check_progress():
    if (Var.hero.realpos[0]-Var.ref_point[0] in range(1090,1110)) and \
       (Var.hero.realpos[1]-Var.ref_point[1] in range(88,100)):
        Var.level_rising = True
...
def setup():
    ...
    Var.units[Var.IDG-1] = ork.Ork("Ork", "Monster", [610-145-msp[0], 180-126-msp[1]])
    Var.units[Var.IDG-1] = ork.Ork("Ork", "Monster", [560-145-msp[0], 110-126-msp[1]])
